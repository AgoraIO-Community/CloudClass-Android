...
import io.agora.whiteboard.netless.bean.AgoraBoardFitMode.Retain
...
class MainActivity2 : AppCompatActivity(), View.OnClickListener {
    ...
    private fun start() {
        ...
        try {
            ...
            var stream = AgoraEduStream(videoState = 1, audioState = 1)
            val agoraEduLaunchConfig = AgoraEduLaunchConfig(userName, userUuid, roomName, roomUuid,
                    roleType, roomType, rtmToken, startTime, duration, roomRegion, stream, Retain,
                    userProperties, null)
            runOnUiThread {
                try {
