...
import io.agora.agoraeducore.core.internal.whiteboard.netless.bean.AgoraBoardFitMode.Retain
import io.agora.agoraeduextapp.AgoraExtAppConfiguration
import io.agora.agoraeduextapp.AgoraExtAppLayoutParam
import io.agora.agoraeduextapp.countdown.CountDownExtApp
...
class MainActivity2 : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvFlexibleVersion.text = String.format(getString(R.string.flexible_version1), BuildConfig.APAAS_VERSION)
