    ...
    class FcrSelectRoomTypeHolder(var binding: ItemSelectClassTypeBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bindView(roomType: Int, fcrRoomType: FcrRoomType) {
            ...
            if (roomType == fcrRoomType.type.value) {
                ...
                binding.fcrTextClassType.setTextColor(ContextCompat.getColor(itemView.context, io.agora.agoraeduuikit.R.color.fcr_white))
            } else {
                ...
                binding.fcrTextClassType.setTextColor(ContextCompat.getColor(itemView.context, io.agora.agoraeduuikit.R.color.fcr_black))
            }
        }
    }
