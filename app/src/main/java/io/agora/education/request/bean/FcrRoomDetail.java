...
public class FcrRoomDetail {
    ...
    public String getShareLink(Context context) {
        ...
        if (AppUserInfoUtils.INSTANCE.getUserInfo() != null) {
            ...
            try {
                ...
                Log.i("FcrRoomDetail", "version=" + version + "||endVersion=" + endVersion + "||sc=" + sc + "||data=" + data);

                shareLink = getShareUrl(version, endVersion, sc);
     ...
     * @return
     */
    public String getShareUrl(String version, String endVersion, String sc) {
        ...
        // 正式环境
        return "https://solutions-apaas.agora.io/apaas/app/prod/release_" + version + "." + endVersion + "x/index.html#/invite?sc=" + sc;
    }
}
