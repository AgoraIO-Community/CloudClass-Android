            ...
            config?.let {
                ...
                chatWidget?.let { popup ->
                    uiHandler.post {
                        ...
                        if (roomInfo.roomType == RoomType.SMALL_CLASS || roomInfo.roomType == RoomType.GROUPING_CLASS) {
                            popup.setChatLayoutBackground(io.agora.agoraeduuikit.R.drawable.agora_round_rect_bg)
                        }
