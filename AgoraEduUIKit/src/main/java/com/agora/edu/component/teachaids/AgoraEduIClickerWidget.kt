 ...
 * description :
 */
class AgoraIClickerWidget : AgoraMovableWidget() {
...
//                    setDraggable(granted)
        ...
        private val listUpdateCallback = object : ListUpdateCallback {
            override fun onInserted(position: Int, count: Int) {
                teacherBinding.studentResultsRecyclerView.handler.post {
...
//            }
        ...
        private fun showAnswerItems(answers: List<String>) {
            studentBinding.answersGridView.handler.post {
        ...
        private fun showAnswerResult(end: Boolean) {
            teacherBinding.answeringLayout.handler.post {
        ...
        private fun switchTimer(properties: Map<String, Any?>, timerRunning: Boolean) {
            ...
            if (timerRunning) {
                ...
                mTimer?.schedule(object : TimerTask() {
                    override fun run() {
                        mTickCount++
                        binding.timerText.handler.post {
...
internal class AnswerAdapter(var context: Context, var dataList: MutableList<String>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.iclicker_answer_preset_item, parent, false)
...
internal class StudentResultsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StudentAnswerHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.iclicker_answer_list_item, parent, false)
