...
import io.agora.agoraeduuikit.databinding.AgoraEduTabComponentBinding
...
class AgoraEduTabComponent : AbsAgoraEduComponent {
    ...
    private val binding = AgoraEduTabComponentBinding.inflate(LayoutInflater.from(context),
        this, true)
