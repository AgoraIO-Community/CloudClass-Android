 ...
 */
class FCRLargeWindowContainerComponent : AbsAgoraEduConfigComponent<FcrUIConfig>,
    ...
    private val defaultSizeWidthPercent = 0.2F
    private val defaultSizeHeightPercent = 0.15F
    ...
    private val roomHandler = object : RoomHandler() {
        override fun onJoinRoomSuccess(roomInfo: EduContextRoomInfo) {
            ...
            val platformEnable =
                (eduContext?.roomContext()?.getRoomProperties()?.get(StaticData.platformEnableKey) as? Double)?.toInt() ?: 1 == State.YES.value
    ...
    override fun initView(agoraUIProvider: IAgoraUIProvider) {
        ...
        eduContext?.widgetContext()?.addWidgetMessageObserver(whiteBoardWidgetMsgObserver, LargeWindow.id)
...
//                extraProperties["zIndex"] = curMaxZIndex
            ...
            widgetConfig?.let { config ->
                ...
                tmpWidget?.let {
                    ...
                    val widgetDirectParent = FcrWidgetDirectParentView(
                        ...
                        this,
                        localUserGranted
                    ) //widgetDirectParent: widget 的容器 (widget的父布局)
    ...
    override fun release() {
        ...
        eduContext?.widgetContext()?.removeWidgetMessageObserver(whiteBoardWidgetMsgObserver, LargeWindow.id)
    }
    ...
    private fun handleLargeWindowEvent(widgetId: String, active: Boolean) {
        ...
        videoWidgets[widgetId]?.widgetInfo?.let { widgetInfo ->
            widgetInfo.roomProperties?.let { properties ->
                ...
                var ownerUserUuid = properties[extraUserUuidKey] as? String // TODO 弃用了
