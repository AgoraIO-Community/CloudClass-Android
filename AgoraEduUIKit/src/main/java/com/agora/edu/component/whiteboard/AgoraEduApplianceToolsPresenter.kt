...
import com.agora.edu.component.whiteboard.data.AgoraEduApplianceData.Companion.getToolResImage
...
class AgoraEduApplianceToolsPresenter(
    var binding: AgoraEduWhiteboardOptionsComponentBinding,
    ...
    fun switchApplianceOptions(isSingle: Boolean) {
        ...
        if (isSingle) {
            ...
            binding.optionItemApplianceGroup.setBackgroundResource(R.drawable.agora_options_icon_bg_default)
            ...
            binding.optionItemApplianceGroup.setBackgroundResource(R.drawable.agora_options_wb_item_bg)
        ...
        // 设置数据
        val resId = getToolResImage(config.activeAppliance)
