...
abstract class FCRCloudDiskResourceFragment :
    Fragment(R.layout.fcr_cloud_disk_resource_fragment_layout),
    ...
    lateinit var binding: FcrCloudDiskResourceFragmentLayoutBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FcrCloudDiskResourceFragmentLayoutBinding.bind(view)
