...
class AgoraEduListVideoComponent : AbsAgoraEduComponent {
    ...
    private fun initRvAdapter(rv: RecyclerView) {//init adapter of the recyclerview
        mVideoAdapter = CoHostVideoAdapter(object : IAgoraUIUserListListener {
...
//        }
    ...
    private inner class CoHostVideoAdapter(val callback: IAgoraUIUserListListener?) : RecyclerView.Adapter<VideoHolder>() {
...
internal class VideoHolder(var view: View, var callback: IAgoraUIUserListListener?) : RecyclerView.ViewHolder(view),
    IAgoraUIVideoListener {

    var uiVideo = view.findViewById<AgoraEduVideoComponent>(R.id.agora_edu_video)

    fun bind(item: VideoItem, agoraUIProvider: IAgoraUIProvider) {
