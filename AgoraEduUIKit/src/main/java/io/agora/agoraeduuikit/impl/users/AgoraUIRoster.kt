...
class AgoraUIRoster(private val eduContext: io.agora.agoraeducore.core.context.EduContextPool?) : AbsComponent() {
    ...
    private val handler = object : io.agora.agoraeducontext.handlerimpl.UserHandler() {
