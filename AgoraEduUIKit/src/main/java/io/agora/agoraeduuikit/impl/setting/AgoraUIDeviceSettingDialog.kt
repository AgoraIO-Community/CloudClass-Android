...
class AgoraUIDeviceSettingDialog(context: Context, anchor: View,
                                 ...
                                 private val eduContext: io.agora.agoraeducore.core.context.EduContextPool?) : Dialog(context, R.style.agora_dialog) {
    ...
    private val eventHandler = object : io.agora.agoraeducontext.handlerimpl.DeViceHandler() {
