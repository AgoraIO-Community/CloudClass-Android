package io.agora.agoraeduuikit.impl.chat.tabs
...
import io.agora.agoraeduuikit.component.RectBackgroundBuilder
import io.agora.agoraeduuikit.impl.chat.AgoraUIChatItem
import io.agora.agoraeduuikit.impl.chat.AgoraUIChatSource
import io.agora.agoraeduuikit.impl.chat.AgoraUIChatState

abstract class ChatTabBase : FrameLayout, IChatTab {
    private val tag = "ChatTabBase"

    var eduContext: io.agora.agoraeducore.core.context.EduContextPool? = null
    ...
    protected inner class ChatItemAdapter : RecyclerView.Adapter<ChatItemViewHolder>() {
        ...
        private fun sendLocalChat(message: String, timestamp: Long) : AgoraUIChatItem? {
            val item: EduContextChatItem? = when (this@ChatTabBase) {
