...
class AgoraUIVideoGroup(
    ...
    private val videoGroupHandler = object : io.agora.agoraeducontext.handlerimpl.VideoHandler() {
    ...
    override fun onRendererContainer(viewGroup: ViewGroup?, streamUuid: String,
        ...
        eduContext?.videoContext()?.renderVideo(viewGroup, streamUuid, renderConfig)
    }
