...
class TabManager(
        ...
        eduContextPool: io.agora.agoraeducore.core.context.EduContextPool?,
...
data class ChatTabConfig(
        val title: String,
        val type: TabType,
        val peerUser: EduContextUserInfo?
)
...
class ChatTabAdapter(
        ...
        private val eduContextPool: io.agora.agoraeducore.core.context.EduContextPool?,
