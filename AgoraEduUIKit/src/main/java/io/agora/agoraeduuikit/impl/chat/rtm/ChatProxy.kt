...
import io.agora.agoraeducore.core.internal.server.requests.http.retrofit.services.deprecated.ChatService
...
class ChatProxy(private val appId: String,
    ...
    private val service = RetrofitManager.instance().getService(
            AgoraEduSDK.baseUrl(), ChatService::class.java)
