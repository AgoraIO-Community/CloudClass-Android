...
import io.agora.agoraeduuikit.impl.tool.AgoraUIToolBar
...
import io.agora.agoraeduuikit.impl.whiteboard.AgoraUIWhiteBoard
import io.agora.agoraeduuikit.impl.whiteboard.paging.AgoraUIPagingControl
...
abstract class AbsUIContainer(
     ...
     */
    private val containerRoomEventHandler = object : io.agora.agoraeducontext.handlerimpl.RoomHandler() {
    ...
    private val containerDeviceEventHandler = object : io.agora.agoraeducontext.handlerimpl.DeViceHandler() {
     ...
     */
    private val containerChatEventHandler = object : io.agora.agoraeducontext.handlerimpl.ChatHandler() {
     ...
     */
    private val containerWhiteboardHandler = object : io.agora.agoraeducontext.handlerimpl.WhiteboardHandler() {
    ...
    private val containerScreenShareHandler = object : io.agora.agoraeducontext.handlerimpl.ScreenShareHandler() {
    ...
    private val containerHandsUpHandler = object : io.agora.agoraeducontext.handlerimpl.HandsUpHandler() {
    ...
    private val containerVideoHandler = object : io.agora.agoraeducontext.handlerimpl.VideoHandler() {
        override fun onMessageUpdated(msg: String) {

        }
    }

    private val containerUserHandler = object : io.agora.agoraeducontext.handlerimpl.UserHandler() {
    ...
    protected val widgetManager = io.agora.agoraeduwidget.UiWidgetManager()
