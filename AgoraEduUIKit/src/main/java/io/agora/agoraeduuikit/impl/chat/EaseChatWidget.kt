...
import io.agora.agoraeducontext.WidgetType
...
class EaseChatWidget : ChatWidget(), InputMsgListener, ViewClickListener, ChatPagerListener {
    ...
    private val roomHandler = object : io.agora.agoraeducontext.handlerimpl.RoomHandler() {
        override fun onClassroomJoinSuccess(roomUuid: String, timestamp: Long) {
            super.onClassroomJoinSuccess(roomUuid, timestamp)
            addEaseIM()
        }
    }
