...
import io.agora.agoraeduuikit.impl.AgoraUIVideoList
...
class AgoraUISmallClassContainer(
    ...
    private val smallContainerTeacherVideoHandler = object : io.agora.agoraeducontext.handlerimpl.VideoHandler() {
    ...
    private val smallContainerUserHandler = object : io.agora.agoraeducontext.handlerimpl.UserHandler() {
