 ...
 * description :
 */
public class FcrMarqueeTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public FcrMarqueeTextView(Context context) {
        this(context, null);
    }

    public FcrMarqueeTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FcrMarqueeTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void startScroll() {
        // 开始位置
        mXPaused = ((View) getParent().getParent()).getWidth() - calculateScrollingLen();
        mPaused = true;
        mFirst = true;
        resumeScroll();
    }
