...
class AgoraEduHandsUpListComponent : AbsAgoraEduComponent {
    ...
    override fun initView(agoraUIProvider: IAgoraUIProvider) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fcr_online_option_handsup_list_popup_layout, this)
    ...
    private fun createItemViewHolder(
        ...
        return ClassUserHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.fcr_online_handsup_list_dialog_listitem, null), listener
        )
    }
...
//                    && oldItem.rewardCount == newItem.rewardCount
    ...
    private inner class UserListAdapter(val listener: UserItemClickListener) : ListAdapter<HandsUpUser, BaseUserHolder>(
        UserListDiff()
    ) {
