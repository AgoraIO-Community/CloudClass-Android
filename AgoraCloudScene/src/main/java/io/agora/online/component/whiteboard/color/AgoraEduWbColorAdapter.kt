package io.agora.online.component.whiteboard.color
...
import io.agora.online.component.whiteboard.adpater.AgoraEduWbToolInfo
import io.agora.online.component.whiteboard.tool.AgoraEduImageUtils
import io.agora.online.R
import io.agora.online.databinding.FcrOnlineEduWbColorItemBinding
...
open class AgoraEduWbColorAdapter<T : AgoraEduWbToolInfo>(var config: AgoraUIDrawingConfig) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AgoraEduWbColorViewHolder<T> {
        val binding = FcrOnlineEduWbColorItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
...
class AgoraEduWbColorViewHolder<T : AgoraEduWbToolInfo>(var binding: FcrOnlineEduWbColorItemBinding) :
