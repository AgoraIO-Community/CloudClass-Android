...
import io.agora.online.databinding.FcrOnlineEduWhiteboardControlBinding
...
class AgoraEduWhiteBoardControlComponent : AbsAgoraEduComponent {
    ...
    private var binding: FcrOnlineEduWhiteboardControlBinding =
        FcrOnlineEduWhiteboardControlBinding.inflate(LayoutInflater.from(context), this, true)
