 ...
 * author : felix
 * date : 2023/6/29
 * description : copy for DefaultPlayerUiController
 */
class FcrDefaultPlayerUiController(
...
//    )
    ...
    var onClickPlayPauseListener: ((Boolean) -> Unit)? = null
    var onClickSeekListener: ((Float) -> Unit)? = null
    ...
    private fun initClickListeners() {
        ...
        youtubePlayerSeekBar.youtubePlayerSeekBarListener = object : YouTubePlayerSeekBarListener {
            override fun seekTo(time: Float) {
                ...
                onClickSeekListener?.invoke(time)
            }
        }
...
//        onMenuButtonClickListener = customMenuButtonClickListener
    ...
    override fun getMenu(): YouTubePlayerMenu? = null //youTubePlayerMenu
    ...
    private fun onPlayButtonPressed() {
        ...
        onClickPlayPauseListener?.invoke(!isPlaying)
    }
