...
import io.agora.online.databinding.FcrOnlineEduTabgroupComponentBinding
...
open class AgoraEduTabGroupComponent : AbsAgoraEduComponent {
    ...
    private var binding: FcrOnlineEduTabgroupComponentBinding = FcrOnlineEduTabgroupComponentBinding.inflate(LayoutInflater.from(context), this, true)
