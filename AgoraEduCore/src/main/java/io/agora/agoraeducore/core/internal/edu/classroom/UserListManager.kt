...
import io.agora.agoraeducore.core.internal.edu.classroom.bean.PropertyData.nameKey
...
import io.agora.agoraeducore.core.internal.edu.common.bean.handsup.HandsUpAction
import io.agora.agoraeducore.core.internal.edu.common.bean.handsup.HandsUpConfig
import io.agora.agoraeducore.core.internal.edu.common.bean.handsup.HandsUpConfig.Companion.handsUpKey
import io.agora.agoraeducore.core.internal.edu.common.bean.handsup.HandsUpConfig.Companion.processesKey
import io.agora.agoraeducore.core.internal.edu.common.bean.handsup.HandsUpResData
...
internal open class UserListManager(
    ...
    fun renderContainer(viewGroup: ViewGroup?, streamUuid: String, renderConfig: EduRenderConfig) {
        getCurRoomFullStream(object : EduCallback<MutableList<EduStreamInfo>> {
            override fun onSuccess(res: MutableList<EduStreamInfo>?) {
                res?.find { it.streamUuid == streamUuid }?.let {
                    eduUser.setStreamView(it, config.roomUuid, viewGroup, renderConfig)
                }
            }
