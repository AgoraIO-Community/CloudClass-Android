package io.agora.agoraeducore.core.internal.whiteboard.netless.manager;
...
import io.agora.agoraeducore.core.internal.whiteboard.netless.annotation.Appliance;
...
//        }
    ...
    public void disableDeviceInputs(boolean disabled) {
        if (t != null) {
            t.setWritable(!disabled, new Promise<Boolean>() {
                @Override
                public void then(Boolean aBoolean) {
