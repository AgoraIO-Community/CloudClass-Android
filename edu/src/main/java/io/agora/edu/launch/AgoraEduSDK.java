...
import io.agora.edu.classroom.widget.whiteboard.RegionUtil;
...
public class AgoraEduSDK {
    ...
    private static String region = AgoraEduRegion.cn;

    public static String baseUrl() {
        return baseUrl.concat(region.toLowerCase()).concat(File.separator);
    }

    public static String reportUrl() {
        return reportUrl.concat(region.toLowerCase()).concat(File.separator);
    }
        ...
        roomPre.preCheckClassRoom(config.getUserUuid(), req, new EduCallback<RoomPreCheckRes>() {
            ...
            public void onSuccess(@Nullable RoomPreCheckRes preCheckRes) {
                ...
                EduManagerOptions options = new EduManagerOptions(context, config.appId,
                        ...
                        preCheckRes.getRtcRegion(), preCheckRes.getRtmRegion());
