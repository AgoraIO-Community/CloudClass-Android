package io.agora.edu.core.internal.edu.common.bean.request;
...
import io.agora.edu.core.internal.edu.common.bean.roompre.LimitConfig;
import io.agora.edu.core.internal.edu.common.bean.roompre.RoleConfig;
import io.agora.edu.core.internal.framework.RoomCreateOptions;
import io.agora.edu.core.internal.framework.RoomType;

import static io.agora.edu.core.internal.framework.Property.*;
...
public class RoomCreateOptionsReq {
    ...
    private static RoleConfig convertRoleConfig(RoomCreateOptions options) {
        ...
        if (options.getRoomType() == RoomType.LARGE_CLASS.getValue()
                || options.getRoomType() == RoomType.MEDIUM_CLASS_OBSOLETE.getValue()) {
            roleConfig.setAudience(new LimitConfig(studentLimit));
        } else if (options.getRoomType() == RoomType.BREAKOUT_CLASS_OBSOLETE.getValue()) {
