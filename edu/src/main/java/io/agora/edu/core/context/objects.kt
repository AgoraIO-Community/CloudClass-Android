...
import io.agora.edu.core.internal.education.api.stream.data.EduMirrorMode
...
data class EduContextRenderConfig(
    ...
    fun convert(): EduRenderConfig {
        ...
        val mirror = when (this.mirrorMode) {
            EduContextMirrorMode.AUTO -> EduMirrorMode.AUTO
            EduContextMirrorMode.ENABLED -> EduMirrorMode.ENABLED
            EduContextMirrorMode.DISABLED -> EduMirrorMode.DISABLED
        }
