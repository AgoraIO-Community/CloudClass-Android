...
import io.agora.edu.core.internal.education.api.stream.data.ScreenStreamInitOptions
...
import io.agora.edu.core.internal.framework.EduTeacherEventListener
...
import io.agora.edu.core.internal.education.impl.stream.data.request.EduDelStreamsBody
import io.agora.edu.core.internal.education.impl.stream.data.request.EduDelStreamsReq
import io.agora.edu.core.internal.education.impl.stream.data.request.EduUpsertStreamsBody
import io.agora.edu.core.internal.education.impl.stream.data.request.EduUpsertStreamsReq
import io.agora.edu.core.internal.framework.EduTeacher
...
internal class EduTeacherImpl(
    ...
    override fun upsertStudentStreams(streamInfos: MutableList<EduStreamInfo>, callback: EduCallback<Unit>) {
        ...
        RetrofitManager.instance()!!.getService(AgoraEduSDK.baseUrl(), StreamService::class.java)
                ...
                .enqueue(RetrofitManager.Callback(0, object : ThrowableCallback<io.agora.edu.core.internal.base.network.ResponseBody<String>> {
                    override fun onSuccess(res: io.agora.edu.core.internal.base.network.ResponseBody<String>?) {
                        callback.onSuccess(Unit)
                    }
