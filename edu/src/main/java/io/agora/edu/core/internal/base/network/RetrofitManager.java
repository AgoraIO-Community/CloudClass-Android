...
//        clientBuilder.retryOnConnectionFailure(false);
    ...
    public static class Callback<T extends ResponseBody<?>> implements retrofit2.Callback<T> {
        private int code;
        private io.agora.edu.core.internal.base.callback.Callback<T> callback;

        public Callback(int code, @NonNull io.agora.edu.core.internal.base.callback.Callback<T> callback) {
            this.code = code;
