...
import io.agora.edu.core.internal.base.network.RetryInterceptor
...
internal class RetrofitManager private constructor() {
    ...
    class Callback<T : ResponseBody<*>?>(private val code: Int,
                                         private val callback: io.agora.edu.core.internal.base.callback.Callback<T>) : retrofit2.Callback<T> {
