package io.agora.edu.uikit.impl.loading
...
class AgoraUILoadingView : LinearLayout {
    private val tag = "AgoraUILoadingView"
    ...
    private fun view() {
        val view = inflate(context, R.layout.agora_ui_loading_view_layout, this)
