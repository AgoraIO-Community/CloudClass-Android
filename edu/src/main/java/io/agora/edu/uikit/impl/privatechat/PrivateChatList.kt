package io.agora.edu.uikit.impl.privatechat
...
class PrivateChatList(val parent: ViewGroup,
                      ...
                      val left: Int,
                      val top: Int,
                    val eduContext: io.agora.edu.core.context.EduContextPool?) : AbsComponent() {
    ...
    fun updatePrivateChatUserList(list: MutableList<io.agora.edu.core.context.EduContextUserDetailInfo>) {
        recycler.post { adapter.updateUserInfo(list) }
    }

    @Synchronized fun setPrivateChatState(started: Boolean, info: io.agora.edu.core.context.EduContextPrivateChatInfo?) {
        recycler.post {
    ...
    inner class PrivateChatListAdapter: RecyclerView.Adapter<PrivateChatViewHolder>() {
        val list = mutableListOf<io.agora.edu.core.context.EduContextUserDetailInfo>()

        var privateChatStarted = false
        var privateChatInfo: io.agora.edu.core.context.EduContextPrivateChatInfo? = null

        fun updateUserInfo(list: MutableList<io.agora.edu.core.context.EduContextUserDetailInfo>) {
            this.list.clear()
        ...
        fun setPrivateChatState(started: Boolean, info: io.agora.edu.core.context.EduContextPrivateChatInfo?) {
