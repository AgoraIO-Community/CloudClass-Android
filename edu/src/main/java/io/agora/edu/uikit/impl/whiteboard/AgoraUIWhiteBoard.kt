...
import io.agora.edu.uikit.handlers.ScreenShareHandler
import io.agora.edu.uikit.handlers.WhiteboardHandler
import io.agora.edu.uikit.impl.loading.AgoraUILoadingView
...
class AgoraUIWhiteBoard(
    ...
    private val whiteboardHandler = object : WhiteboardHandler() {
        override fun onBoardPhaseChanged(phase: io.agora.edu.core.context.EduBoardRoomPhase) {
    ...
    fun setLoadingState(phase: io.agora.edu.core.context.EduBoardRoomPhase) {
        loadingView.visibility = if (phase == io.agora.edu.core.context.EduBoardRoomPhase.connected) GONE else VISIBLE
        if (phase == io.agora.edu.core.context.EduBoardRoomPhase.connecting) {
            loadingView.setContent(true)
        } else if (phase == io.agora.edu.core.context.EduBoardRoomPhase.reconnecting) {
