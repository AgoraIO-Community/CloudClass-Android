package io.agora.edu.uikit.impl.screenshare
...
class AgoraUIScreenShare(
    ...
    private val screenShareHandler = object : ScreenShareHandler() {
        override fun onScreenShareStateUpdated(state: io.agora.edu.core.context.EduContextScreenShareState, streamUuid: String) {
    ...
    fun updateScreenShareState(state: io.agora.edu.core.context.EduContextScreenShareState, streamUuid: String) {
        contentView.post {
            val sharing = state == io.agora.edu.core.context.EduContextScreenShareState.Start
