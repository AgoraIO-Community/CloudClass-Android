...
class AgoraUIToolDialog(context: Context,
    ...
    private inner class StyleAdapter(private val recyclerView: RecyclerView) : RecyclerView.Adapter<StyleViewHolder>() {
        private val iconsRes = arrayOf(
                ...
                StyleItem(R.drawable.agora_tool_icon_rect, AgoraUIApplianceType.Rect),
                StyleItem(R.drawable.agora_tool_icon_circle_ring, AgoraUIApplianceType.Circle),
                StyleItem(R.drawable.agora_tool_icon_line, AgoraUIApplianceType.Line))
        ...
        override fun onBindViewHolder(holder: StyleViewHolder, position: Int) {
            ...
            holder.itemView.setOnClickListener {
                ...
                listener.onToolbarItemsUpdated(item.type)
            }
        }
...
interface AgoraUIToolDialogListener {
    ...
    fun onToolbarItemsUpdated(appliance: AgoraUIApplianceType)
}
