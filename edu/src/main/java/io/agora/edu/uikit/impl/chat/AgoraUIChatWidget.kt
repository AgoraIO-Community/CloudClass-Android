...
import io.agora.edu.uikit.component.RoundRectButtonStateBg
import io.agora.edu.uikit.handlers.ChatHandler
import io.agora.edu.uikit.impl.AgoraAbsWidget
import io.agora.edu.uikit.impl.chat.tabs.*
...
class AgoraUIChatWidget : ChatWidget() {
    ...
    private val chatHandler = object : ChatHandler() {
        override fun onReceiveMessage(item: io.agora.edu.core.context.EduContextChatItem) {
        ...
        override fun onReceiveChatHistory(history: List<io.agora.edu.core.context.EduContextChatItem>) {
        ...
        override fun onReceiveConversationMessage(item: io.agora.edu.core.context.EduContextChatItem) {
            tabManager.addMessage(TabType.Private, AgoraUIChatItem.fromContextItem(item))
        }

        override fun onReceiveConversationHistory(history: List<io.agora.edu.core.context.EduContextChatItem>) {
            val result = mutableListOf<AgoraUIChatItem>()
            history.forEach { item ->
                result.add(AgoraUIChatItem.fromContextItem(item))
            }
        ...
        override fun onChatAllowed(allowed: Boolean, userInfo: io.agora.edu.core.context.EduContextUserInfo,
                                   operator: io.agora.edu.core.context.EduContextUserInfo?, local: Boolean) {
    ...
    companion object {
        ...
        var roomInfo: io.agora.edu.core.context.EduContextRoomInfo? = null
    }
