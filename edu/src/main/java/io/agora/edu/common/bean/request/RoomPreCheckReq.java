...
import io.agora.edu.launch.AgoraEduStream;
...
public class RoomPreCheckReq {
    ...
    public RoomPreCheckReq(@NotNull String roomName, int roomType, @NotNull String role,
                           ...
                           @Nullable String boardRegion, @Nullable AgoraEduStream stream,
    ...
    public AgoraEduStream getStream() {
        return stream;
    }

    public void setStream(AgoraEduStream stream) {
        this.stream = stream;
    }
