...
object AgoraClassSdk {
    ...
    private fun registerWidgets() {
        ...
        cnWidgetConfigs.add(AgoraWidgetConfig(
            widgetClass = AgoraUILargeVideoWidget::class.java,
            widgetId = AgoraWidgetDefaultId.LargeWindow.id))
    ...
    private fun addRoomClassTypes() {
        ...
        if (BuildConfig.isArtScene.toBoolean()) {
            ClassInfoCache.addRoomActivityDefault(RoomType.SMALL_CLASS.value, SmallClassArtActivity::class.java)
        } else {
            ClassInfoCache.addRoomActivityDefault(RoomType.SMALL_CLASS.value, SmallClassActivity::class.java)
        }
        if (BuildConfig.isArtScene.toBoolean()) {
            ClassInfoCache.addRoomActivityDefault(RoomType.LARGE_CLASS.value, LectureHallArtActivity::class.java)
        } else {
