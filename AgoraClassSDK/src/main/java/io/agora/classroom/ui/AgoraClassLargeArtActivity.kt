...
import io.agora.agoraclasssdk.databinding.ActivityAgoraClassLargeArtBinding
 ...
 * description : 大班课（Art）
 */
class AgoraClassLargeArtActivity : AgoraEduClassActivity() {
    private val TAG = "AgoraClassLargeActivity"

    lateinit var binding: ActivityAgoraClassLargeArtBinding
    private var agoraClassVideoPresenter: AgoraClassSmallArtPresenter? = null
    ...
    private val roomHandler = object : RoomHandler(), AgoraUILargeVideoWidget.IAgoraUILargeVideoListener {
        ...
        override fun onJoinRoomFailure(roomInfo: EduContextRoomInfo, error: EduContextError) {
            ...
            AgoraUIToast.error(context = this@AgoraClassLargeArtActivity, text = error.msg)
...
//                notifyVideos()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAgoraClassLargeArtBinding.inflate(layoutInflater)
    ...
    private fun joinClassRoom() {
        runOnUiThread {
            ...
            eduCore()?.eduContextPool()?.let { context ->
                ...
                binding.agoraEduWhiteboard.initView(this)

                binding.agoraClassUserListVideo.classRoomType = RoomType.LARGE_CLASS
                agoraClassVideoPresenter =
                    AgoraClassSmallArtPresenter(binding.agoraClassTeacherVideo, binding.agoraClassUserListVideo)
            ...
            var rootContainer = binding.agoraContainerLargeArt
